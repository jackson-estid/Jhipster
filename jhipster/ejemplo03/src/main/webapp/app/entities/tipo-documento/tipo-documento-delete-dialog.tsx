...
export const TipoDocumentoDeleteDialog = () => {
  ...
  return (
    <Modal show onHide={handleClose}>
      ...
      <ModalBody id="ejemplo03App.tipoDocumento.delete.question">
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-tipoDocumento" data-cy="entityConfirmDeleteButton" variant="danger" onClick={confirmDelete}>
