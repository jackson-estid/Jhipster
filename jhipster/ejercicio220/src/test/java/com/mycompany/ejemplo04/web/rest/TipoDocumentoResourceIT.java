...
import com.mycompany.ejemplo03.repository.TipoDocumentoRepository;
import com.mycompany.ejemplo03.service.dto.TipoDocumentoDTO;
import com.mycompany.ejemplo03.service.mapper.TipoDocumentoMapper;
...
class TipoDocumentoResourceIT {
    ...
    void partialUpdateTipoDocumentoWithPatch() throws Exception {
        ...
        partialUpdatedTipoDocumento.sigla(UPDATED_SIGLA).nombreDocumento(UPDATED_NOMBRE_DOCUMENTO);
