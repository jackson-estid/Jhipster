...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './tabla.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TABLA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TABLA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TABLA actions', async () => {
      const arg = { id: '673acf30-2725-48a0-9293-9c6d7b16e4f1' };
    ...
    it('dispatches UPDATE_TABLA actions', async () => {
      const arg = { id: '673acf30-2725-48a0-9293-9c6d7b16e4f1' };
    ...
    it('dispatches PARTIAL_UPDATE_TABLA actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_TABLA actions', async () => {
      const arg = 42666;
